                        ...
                        <div class="product-thumb transition">
                                ...
                                <div class="button-group">
                                    <div class="cart">
                                        <button class="btn btn-primary btn-primary" type="button" data-toggle="tooltip"
                                                ...
                                                style="display: none; width: 33.3333%;" data-original-title="加入到购物车"><i
                            ...
                            <div class="caption">
                                <div class="name" style="height:40px"><a
                                   ...
                                   <span style="color:#0885B1">名称：</span>  <?php echo $info['mingcheng'];?> </a></div>
                                <div class="name" style="margin-top:10px">
                                  <span style="color:#0885B1">分类：</span><?php echo $info['typename'];?> </div>
														...
														<div class="product-thumb transition">
															...
															<div class="caption">
																<div class="name" style="height:40px">
																	<a href="goodsDetail.php?id=<?php echo $info['id'];?>" style="width:95%"> <span style="color:#0885B1">名称：</span>  <?php echo $info['mingcheng'];?> </a>
																</div>
																<div class="name" style="margin-top:10px">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 copyright ">
                    <small>
                        Copyright &nbsp;<a href="http://www.mingrisoft.com/" target="_blank">古道西风小羊驼</a>
                        <a href="admin/index.php">后台</a>
                    </small>
                    <small>
                        邮箱：1533036253@qq.com &nbsp;&nbsp;电话：18362961528
                    </small>
                    <small>
                        地址:拆妮斯
                    </small>
